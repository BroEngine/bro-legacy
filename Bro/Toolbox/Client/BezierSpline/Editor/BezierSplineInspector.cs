...
namespace Bro.Toolbox.Client
{
    ...
    public class BezierSplineInspector : UnityEditor.Editor
    {
        ...
        private void OnSceneGUI()
        {
            ...
            _handleRotation = UnityEditor.Tools.pivotRotation == PivotRotation.Local ? _handleTransform.rotation : Quaternion.identity;
        ...
        private void DrawSelectedPointInspector()
        {
            ...
            EditorGUI.BeginChangeCheck();
            float length = EditorGUILayout.FloatField("Length", _spline.GetCurveLength(_selectedIndex));
            if (EditorGUI.EndChangeCheck())
            {
                Undo.RecordObject(_spline, "Change Curve Length");
                _spline.SetCurveLength(_selectedIndex, length);
                EditorUtility.SetDirty(_spline);
            }
        }
