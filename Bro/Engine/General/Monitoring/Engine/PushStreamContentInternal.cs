...
namespace Bro.Monitoring
{
    ...
    {
        private readonly Func<Stream, HttpContent, TransportContext, System.Threading.Tasks.Task> _onStreamAvailable;
        ...
        /// </summary>
        public PushStreamContentInternal(Func<Stream, HttpContent, TransportContext, System.Threading.Tasks.Task> onStreamAvailable, MediaTypeHeaderValue mediaType)
        {
