...
namespace Bro.Monitoring
{
    ...
    internal sealed class TextSerializer : IMetricsSerializer
    {
        ...
        public async System.Threading.Tasks.Task FlushAsync(CancellationToken cancel)
        {
        ...
        // # HELP name help
        // # TYPE name type
        public async System.Threading.Tasks.Task WriteFamilyDeclarationAsync(byte[][] headerLines, CancellationToken cancel)
        {
        ...
        public async System.Threading.Tasks.Task WriteMetricAsync(byte[] identifier, double value, CancellationToken cancel)
        {
