...
namespace Bro.Monitoring
{
    ...
    public abstract class Collector
    {
        ...
        internal abstract System.Threading.Tasks.Task CollectAndSerializeAsync(IMetricsSerializer serializer, CancellationToken cancel);
        ...
        where TChild : ChildBase
    {
            ...
            : base(name, help, labelNames)
        {
            ...
            _unlabelledLazy = new Lazy<TChild>(() => GetOrAddLabelled(Bro.Monitoring.Labels.Empty));
        ...
        internal override async System.Threading.Tasks.Task CollectAndSerializeAsync(IMetricsSerializer serializer, CancellationToken cancel)
        {
        ...
        private void EnsureUnlabelledMetricCreatedIfNoLabels()
        {
            ...
            if (!_unlabelledLazy.IsValueCreated && !LabelNames.Any())
                GetOrAddLabelled(Bro.Monitoring.Labels.Empty);
        }
    }
}
#endif