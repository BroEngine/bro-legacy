...
namespace Bro.Monitoring
{
    ...
    public abstract class ChildBase : ICollectorChild, IDisposable
    {
        ...
        /// </remarks>
        internal System.Threading.Tasks.Task CollectAndSerializeAsync(IMetricsSerializer serializer, CancellationToken cancel)
        {
        ...
        private protected abstract System.Threading.Tasks.Task CollectAndSerializeImplAsync(IMetricsSerializer serializer, CancellationToken cancel);
