...
namespace Bro.Monitoring
{
    ...
    public sealed class CollectorRegistry
    {
        ...
        /// If multiple concurrent collections occur, the callback may be called multiple times concurrently.
        /// </summary>
        public void AddBeforeCollectCallback(Func<CancellationToken, System.Threading.Tasks.Task> callback)
        {
            if (callback == null)
                throw new ArgumentNullException(nameof(callback));
        ...
        /// </summary>
        public System.Threading.Tasks.Task CollectAndExportAsTextAsync(Stream to, CancellationToken cancel = default)
        {
            if (to == null)
        ...
        private readonly ConcurrentBag<Func<CancellationToken, System.Threading.Tasks.Task>> _beforeCollectAsyncCallbacks = new ConcurrentBag<Func<CancellationToken, System.Threading.Tasks.Task>>();
        ...
        /// </summary>
        internal async System.Threading.Tasks.Task CollectAndSerializeAsync(IMetricsSerializer serializer, CancellationToken cancel)
        {
            lock (_firstCollectLock)
            {
                if (!_hasPerformedFirstCollect)
            ...
            await System.Threading.Tasks.Task.WhenAll(_beforeCollectAsyncCallbacks.Select(callback => callback(cancel)));
