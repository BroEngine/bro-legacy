...
namespace UnityEngine
{
    ...
    [Serializable, JsonType("vector_2")]
    ...
    public struct Vector2 : IEquatable<Vector2>, IFormattable
    {
        ...
        [JsonIgnore] public float magnitude { [MethodImpl(MethodImplOptionsEx.AggressiveInlining)] get { return (float)Math.Sqrt(x * x + y * y); } }
        // Returns the squared length of this vector (RO).
        [JsonIgnore] public float sqrMagnitude { [MethodImpl(MethodImplOptionsEx.AggressiveInlining)] get { return x * x + y * y; } }
